...
public enum ErrorCode {
    ...
    INVALID_IDEMPOTENCY_KEY(HttpStatus.BAD_REQUEST, "PAY-CORE-003", "PAYMENT_IDEMPOTENCY_KEY_INVALID", "잘못된 멱등성키입니다."),
    ...
    INTERNAL_PG_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "PAY-PG-401", "PG_SERVICE_UNAVAILABLE",
            "PG 서버 내부 오류가 발생했습니다."),
    INTERNAL_AUTH_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "PAY-AUTH-401", "AUTH_SERVICE_UNAVAILABLE",
            "AUTH 서버 내부 오류가 발생했습니다."),
    INTERNAL_CARD_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "PAY-CARD-401", "CARD_SERVICE_UNAVAILABLE",
